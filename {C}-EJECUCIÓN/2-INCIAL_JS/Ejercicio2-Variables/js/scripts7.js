...
function venta() {
    ...
    document.getElementById('resultado').innerHTML='El importe a abonar es de: ' + total + '€' 
}

function borrar() {
    contador=0
    document.getElementById('nºClick').innerHTML=(contador);
    document.getElementById('resultado').innerHTML= 'El importa a abonar es de: ' + contador + ' €';
    if (contador === 0);
    document.getElementById('marquee-container').stop();
}
